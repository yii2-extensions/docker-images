...
REQUIRED_FILES=(
    ...
    "src/flavor/apache/etc/apache2/conf-available/php-fpm-proxy.conf"
    "src/flavor/apache/etc/apache2/conf-available/security.conf"
    "src/flavor/apache/etc/apache2/conf-available/vhost-common.conf"
